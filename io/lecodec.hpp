...
*/
#ifndef __BIN_SON_LITTLE_ENDIAN_BYTE_ORDER_H__
#define __BIN_SON_LITTLE_ENDIAN_BYTE_ORDER_H__
...
namespace io
{
	...
	public:
		...
		inline static T encode(const IN_TYPE& t_in)
		{
			...
			{
				temp.buffer[(i)] = static_cast<t_uint8>((value >> (i << 3)));
			}
			return temp.result;
		}
...
#endif //__BIN_SON_LITTLE_ENDIAN_BYTE_ORDER_H__
